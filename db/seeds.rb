...
20.times do |num|
  User.create(name: "user#{num}", email: "user#{num}@gmail.com", password: "11111111", encrypted_password: "11111111", first_name: "寧夢#{num}", last_name: "遊座#{num}", first_name_kana: "ネイム#{num}", last_name_kana: "ユウザ#{num}", postal_code: 1000000 + num, prefecture: num + 1, city:"保外市", address:"#{num}", phone: 9000000000 + num + num * 10000, birthday: 20000101 + num, money: 50000, point: 3000, seller_id: num, buyer_id: num, profile: "よろしく！")
end
